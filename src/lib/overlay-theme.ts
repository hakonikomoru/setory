...
export const OVERLAY_THEME_OPTIONS: {
  ...
  },
  {
    value: "komoru",
    label: "ネオン（アニメ）",
    description: "NOW ラベルが永続的に光る配信向け演出",
  },
  {
    value: "pulse",
    label: "パルス（アニメ）",
    description: "NOW 曲名がゆっくり明滅する読みやすさ重視の演出",
  },
  {
    value: "shimmer",
    label: "シマー（アニメ）",
    description: "曲名に光が流れるシマー演出",
  },
  {
    value: "aurora",
    label: "オーロラ（アニメ）",
    description: "ラベル色がゆるく移ろう配信向け演出",
  },
  {
    value: "signal",
    label: "シグナル（アニメ）",
    description: "左ラインが点滅して NOW を強調",
  },
];
...
export const OVERLAY_THEMES: Record<OverlayTheme, OverlayThemeDefinition> = {
  ...
  komoru: {
    id: "komoru",
    label: "ネオン（アニメ）",
    description: "NOW ラベルが永続的に光る配信向け",
    colors: {
      label: "#f0abfc",
      primary: "#ffffff",
      secondary: "#ede9fe",
  ...
  shimmer: {
    ...
    rootClass: "overlay-theme-shimmer",
    nowBlockClass: "",
    classNames: {
      label: "text-sm font-black uppercase tracking-wider text-violet-700",
      nowTitle: "text-4xl font-black leading-none text-violet-950",
  ...
  aurora: {
    ...
    rootClass: "overlay-theme-aurora",
    nowBlockClass: "rounded-xl bg-slate-950/30 px-4 py-3 backdrop-blur-[2px]",
    classNames: {
      label: "text-xs font-bold uppercase tracking-wide text-cyan-200",
      nowTitle:
        "text-3xl font-black leading-tight text-white drop-shadow-[0_0_10px_rgba(34,211,238,0.35)]",
      nowTitleCompact:
        "text-2xl font-black leading-tight text-white drop-shadow-[0_0_8px_rgba(34,211,238,0.3)]",
      nowSub: "text-lg font-bold leading-snug text-sky-100",
      nowSubCompact: "text-base font-bold leading-snug text-sky-100",
      nextTitle: "text-base font-bold leading-snug text-sky-100/90",
      nextTitleCompact: "text-sm font-bold leading-snug text-sky-100/90",
      nextSub: "text-sm font-semibold leading-snug text-sky-100/80",
      nextSubCompact: "text-xs font-semibold leading-snug text-sky-100/80",
      sectionBorder: "border-cyan-300/35",
      sub: "text-lg font-bold leading-snug text-sky-100",
      setlistLabel: "text-xs font-bold uppercase tracking-wide text-cyan-200",
      setlistLine: "text-xs font-bold leading-snug text-sky-100/75",
      fullSetlistTitle: "text-2xl font-black leading-tight text-white",
      fullSetlistTitleCompact: "text-xl font-black leading-snug break-words text-white",
      fullSetlistSub: "text-base font-bold leading-snug text-sky-100",
      fullSetlistCurrent:
        "text-cyan-200 underline decoration-2 underline-offset-4 decoration-cyan-300",
    },
  },
  signal: {
    id: "signal",
    ...
    rootClass: "overlay-theme-signal",
    nowBlockClass: "border-l-4 border-fuchsia-600 pl-4",
    classNames: {
      label: "text-sm font-black uppercase tracking-wider text-fuchsia-700",
      nowTitle: "text-4xl font-black leading-none text-fuchsia-950",
      nowTitleCompact: "text-2xl font-black leading-none text-fuchsia-950",
      nowSub: "text-base font-bold leading-snug text-fuchsia-900",
      nowSubCompact: "text-sm font-bold leading-snug text-fuchsia-900",
      nextTitle: "text-base font-bold leading-snug text-fuchsia-900",
      nextTitleCompact: "text-sm font-bold leading-snug text-fuchsia-900",
      nextSub: "text-sm font-semibold leading-snug text-fuchsia-900/90",
      nextSubCompact: "text-xs font-semibold leading-snug text-fuchsia-900/90",
      sectionBorder: "border-fuchsia-500/50",
      sub: "text-base font-bold leading-snug text-fuchsia-900",
      setlistLabel: "text-sm font-black uppercase tracking-wider text-fuchsia-700",
      setlistLine: "text-xs font-bold leading-snug text-fuchsia-900/85",
      fullSetlistTitle: "text-3xl font-black leading-tight text-fuchsia-950",
      fullSetlistTitleCompact: "text-xl font-black leading-snug break-words text-fuchsia-950",
      fullSetlistSub: "text-base font-bold leading-snug text-fuchsia-900",
      fullSetlistCurrent: "underline decoration-4 underline-offset-4 decoration-fuchsia-600",
    },
  },
};
