...
const features = [
  {
    href: "/library",
    title: "曲庫を管理",
    body: "曲名・アーティスト・尺・タグ・雰囲気を登録。配信で歌う曲だけをストックできます。",
    ...
    <main className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-5xl flex-col px-4 py-10">
      <section className="rounded-[2rem] border border-violet-100 bg-white/90 p-8 shadow-xl shadow-violet-100/60 sm:p-12">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            href="/builder"
            className="rounded-2xl bg-violet-600 px-6 py-3 font-bold text-white shadow-lg shadow-violet-200 transition hover:bg-violet-700"
          >
            セトリを作る
          </Link>
          <Link
            href="/library"
            className="rounded-2xl border-2 border-violet-200 bg-white px-6 py-3 font-bold text-violet-800 transition hover:bg-violet-50"
          >
            曲庫を見る
          </Link>
        </div>
